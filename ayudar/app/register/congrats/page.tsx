      ...
      <main className="p-4 bg-white rounded-[15px] mt-20 mr-4 ml-5">
        ...
        <section className="block md:hidden mt-8 mb-20 text-center text-[#00000]">
          <div className="flex justify-center items-center">
            <img src={congrats.src} alt="misión" className="w-40 h-40 object-contain" />
          </div>
          <h2 className="text-lg font-semibold mb-4 text-black">¡Bienvenido!</h2>
        ...
        <section className="hidden md:block mt-8 mb-20 text-center text-[#00000]">
          <div className="flex justify-center items-center">
            <img src={congrats.src} alt="misión" className="w-86 h-86 object-contain" />
          </div>

      ...
      <div className="max-w-screen-lg mx-4 mt-8 p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="flex items-start gap-4 mb-6">
          <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0">
            <img 
              src={AvatarUno.src} alt="Avatar Uno"
        ...
        <p className="text-sm text-gray-600 mb-6">
          Somos una organización comunitaria dedicada a brindar asistencia alimentaria 
          a personas en situación de vulnerabilidad. Estamos ubicados en una zona de 
          alto riesgo social. Buscamos ofrecer una comida nutritiva y un espacio de 
          contención a quienes más lo necesitan.
        </p>
